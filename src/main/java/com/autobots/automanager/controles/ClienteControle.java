...
import com.autobots.automanager.modelo.ClienteExclusor;
...
public class ClienteControle {
	...
	public void excluirClienteDados(@RequestBody Cliente exclusao) {
		Cliente cliente = repositorio.getById(exclusao.getId());
		ClienteExclusor exclusor = new ClienteExclusor();
